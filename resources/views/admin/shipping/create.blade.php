...
<div class="main-content">
    ...
    <section class="widget-card">
        <form action="{{ route('store.shipping') }}" method="POST">
            ...
            <div class="col-lg-4 col-xl-4 mt-3">
                ...
                <p class="card-text"><span class="t-font-bold">Write district name from here.</span></p>
    ...
    <div class="col-lg-8 col-xl-8 mt-3">
        ...
        <div class="mt-3 mb-5">
            <input type="submit" style="float:right" class="btn btn-md btn-primary mb-3" value="Add Shipping">
        </div>
    </div>
        </form>
    </section>
