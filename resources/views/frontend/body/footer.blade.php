	...
	<div class="copyright-bar">
		<div class="container">
			<div class="col-xs-12 col-sm-6 no-padding social">
				<ul class="link">
					<li class="fb pull-left"><a rel="nofollow" href="{{ $setting->facebook }}" title="Facebook"></a></li>
					<li class="tw pull-left"><a rel="nofollow" href="{{ $setting->twitter }}" title="Twitter"></a></li>
					<li class="linkedin pull-left"><a rel="nofollow" href="{{ $setting->instagram }}" title="Instagram"></a></li>
				</ul>
			</div>
